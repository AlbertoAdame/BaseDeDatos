...
INSERT INTO CURSOS VALUES ('Inglés Básico',1,'43215643',15,STR_TO_DATE('01/11/00','%d/%m/%y'),STR_TO_DATE('22/12/00','%d/%m/%y'), 120);
INSERT INTO CURSOS VALUES ('Administración Linux',2,'32432455',NULL,STR_TO_DATE('01/09/00','%d/%m/%y'),NULL, 80);


INSERT INTO ALUMNOS VALUES ('Lucas','Manilva','López','123523','Alhamar,3','H',STR_TO_DATE('01/11/79','%d/%m/%y'),1);
...
INSERT INTO ALUMNOS VALUES ('Sergio','Pérez','Caballar','4896765','Jarcha,5','H',STR_TO_DATE('03/02/77','%d/%m/%y'),2);
