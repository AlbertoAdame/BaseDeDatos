...
DELETE DEPARTAMENTO WHERE UPPER(nombre) = UPPER('Proyectos'); --donde va el = podria poner un LIKE

--8. Elimina el departamento Desarrollo. ¿Es posible eliminarlo? Si no fuese
--posible, ¿qué cambios debería realizar para que fuese posible borrarlo?

DELETE DEPARTAMENTO WHERE nombre='Desarrollo'; --NO podremos pq hay que poner ON DELETE CASCADE 
...
DELETE DEPARTAMENTO WHERE nombre='Desarrollo'; -- Y YA NOS DEJARÁ BORRARLO
